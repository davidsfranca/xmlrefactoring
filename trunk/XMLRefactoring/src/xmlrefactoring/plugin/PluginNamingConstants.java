...
public class PluginNamingConstants {
	...
	public static final String ATTR_2_ELEM_PROCESSOR_IDENTIFIER = "Attr2ElemProcessor";
	
	public static final String ATTR_2_ELEM_TRANSF_NAME = "Attribute into element transformation";
